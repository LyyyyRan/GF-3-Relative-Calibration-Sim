...
def EnergyExtract(ROI):
    ...
    ROI_Upsampled = IFFT_Range(IFFT_Azimuth(ROI_f_Padded, shift=False), shift=False)  # Back to Range-Azimuth Space Domain:
    ...
    ROI_BBox_show = cv.rectangle(ROI_BBox_show, (175, 0), (210, Na - 1), color=(255, 0, 0),
...
#
# plt.figure()
# plt.title('ROI_5_Upsampled'.format(idx))
# plt.imshow(img2View(ROI_Upsampled, enhance=False))
