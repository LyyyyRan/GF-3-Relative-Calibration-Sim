...
save('S_echo-NoNoise.mat',"S_echo" )
...
%% 方位压缩
%  根据变化的 R0 计算出相应的 Ka 矩阵(距离向变化，方位向不变)
...
% path_tosave = '../CalibrationBasedonNanoSatelites-Dataset/mat_files/Focused_Data_' + string(which_satelite) + '_' + string(RCS(which_satelite)) + '-NoNoise' + '.mat';

path_tosave = './Focused_Data_' + string(which_satelite) + '_' + string(RCS(which_satelite)) + '-NoNoise' + '.mat';
